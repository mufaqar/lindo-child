<header id="goal-header" class="goal-header header-default visible-lg" role="banner">
    <div class="<?php echo (lindo_get_config('keep_header') ? 'main-sticky-header-wrapper' : ''); ?>">
        <div class="<?php echo (lindo_get_config('keep_header') ? 'main-sticky-header' : ''); ?>">
                ...
                <div class="row flex-middle">
                    ...
                    <div class="col-md-9 p-static flex-middle">
                        ...
                        <div class="header-right pull-right clearfix">
                            ...
                            <?php if ( class_exists( 'YITH_WCWL' ) && lindo_get_config('show_wishlist_btn', true) ){
                            ...
                            <?php } elseif( lindo_is_woosw_activated() ) {
