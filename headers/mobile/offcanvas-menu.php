<div id="goal-mobile-menu" class="goal-offcanvas hidden-lg"> 
    <div class="goal-offcanvas-body">
                            ...
                            <div class="pull-right">
                                ...
                                <div class="top-cart">
                                    ...
                                    <div class="goal-topcart">
                                        <div class="cart">
                                            <a class="mini-cart" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e('View your shopping cart', 'lindo'); ?>">
        ...
        <div class="middle-offcanvas">
            ...
            <?php
                if ( defined('LINDO_WOOCOMMERCE_ACTIVED') && lindo_get_config('show_searchform', true) ) {
            ...
            <nav id="menu-main-menu-navbar" class="navbar navbar-offcanvas" role="navigation">
                <?php
                    ...
                    $args = array(
                        ...
                        'walker' => new Lindo_Mobile_Menu()
                    );
                    wp_nav_menu($args);

                ?>

                <?php if ( lindo_get_config('show_login_register', true) ) { ?>
                    <a class="my-account" href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>">
                        <?php if ( is_user_logged_in() ) { ?>
                            <?php esc_html_e('MY ACCOUNT', 'lindo'); ?>
                        <?php }else{ ?>
                            <?php esc_html_e('LOGIN & REGISTER', 'lindo'); ?>
                        <?php } ?>
                    </a>
                <?php } ?>
            </nav>
        </div>
        <?php if ( is_active_sidebar( 'header-mobile-bottom' ) || lindo_get_config('show_login_register', true) ) { ?>
